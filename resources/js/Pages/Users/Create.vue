        ...
        <div class="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
            ...
            <form class="mt-4" @submit.prevent="submit">
                ...
                <label class="block">
                    ...
                    <span v-if="form.errors.email" v-text="form.errors.email" class="text-xs text-red-600"></span>
                </label>

                <label class="block mt-3">
                    <span class="text-sm text-gray-700">Password</span>
                    <input v-model="form.password" type="password" class="block w-full p-2 mt-1 border">
                    <span v-if="form.errors.password" v-text="form.errors.password" class="text-xs text-red-600"></span>
                </label>
